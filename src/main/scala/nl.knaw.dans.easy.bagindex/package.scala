...
package object bagindex {
  ...
  case class NoIdentifierFoundException(identifierType: String, datasetXML: Path) extends Exception(s"The metadata/dataset.xml at '$datasetXML' does not contain $identifierType identifier")
